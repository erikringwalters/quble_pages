// A customized shader that borrows heavily from Bevy's default PBR Fragment shader, but uses parameters to control the appearance of different instances of meshes, ie. color, glow, etc.
